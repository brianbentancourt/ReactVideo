...
var _homeLayout = __webpack_require__(16);
...
var _related = __webpack_require__(32);
...
var _modal3 = __webpack_require__(44);

var _modal4 = _interopRequireDefault(_modal3);

var _handleError = __webpack_require__(46);
...
var Home = function (_Component) {
	...
	function Home() {
		...
		}, _this.hadleCloseModal = function (event) {
			_this.setState({
				modalVisible: false
			});
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					this.state.modalVisible && _react2.default.createElement(
						...
						_react2.default.createElement(
							_modal4.default,
							{ handleClick: this.hadleCloseModal },
...
function Playlist(props) {
	return _react2.default.createElement(
		...
		props.playlist.map(function (item) {
			return _react2.default.createElement(_media2.default, _extends({
...
function Related(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      'div',
      null,
      _react2.default.createElement('img', { src: 'images/logo.png', width: 250, alt: '' })
    )
  );
}
...
*/
var aa=__webpack_require__(4),ba=__webpack_require__(0),m=__webpack_require__(9),p=__webpack_require__(1),v=__webpack_require__(2),da=__webpack_require__(10),ea=__webpack_require__(11),fa=__webpack_require__(12),ha=__webpack_require__(5);
...
var _regularError = __webpack_require__(47);
	...
	_createClass(HandleError, [{
		...
		value: function render() {
			if (this.state.handleError) {
				return _react2.default.createElement(_regularError2.default, this.state);
			}
...
var _videoPlayerLayout = __webpack_require__(49);
...
var _timer = __webpack_require__(59);

var _timer2 = _interopRequireDefault(_timer);

var _videoPlayerControls = __webpack_require__(61);

var _videoPlayerControls2 = _interopRequireDefault(_videoPlayerControls);

var _time = __webpack_require__(63);

var _browser = __webpack_require__(64);
	...
	function VideoPlayer() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoPlayer.__proto__ || Object.getPrototypeOf(VideoPlayer)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
			...
			_this.setState({
				...
				durationStr: (0, _time.formatTime)(_this.video.duration)
			});
		}, _this.handleTimeUpdate = function (event) {
			_this.setState({
				currentTime: _this.video.currentTime,
				currentTimeStr: (0, _time.formatTime)(_this.video.currentTime)
			});
			...
			_this.setState({
				lastVolumeState: _this.video.volume,
			...
			if (_this.video.volume > 0) {
				...
				_this.video.volume = _this.state.lastVolumeState;
			}
			_this.setState({
				volume: _this.video.volume
			});
		}, _this.handleFullScreenClick = function (event) {
			if (!(0, _browser.IsFullScreen)()) {
				(0, _browser.RequestFullScreen)(_this);
			} else {
				(0, _browser.ExitFullScreen)();
			}
...
var _pause = __webpack_require__(58);
...
function formatTime(secs) {
	var minutos = parseInt(secs / 60, 10);
	var segundos = parseInt(secs % 60, 10);
...
var _volumeMute = __webpack_require__(71);
...
function Volume(props) {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			props.volume > 0 ? _react2.default.createElement(_volume2.default, {
				color: 'white',
				size: 25
			}) : _react2.default.createElement(_volumeMute2.default, {
				color: 'white',
				size: 25
			})
		),
